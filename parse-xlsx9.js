...
let currentSub = null;
let productCount = 0;
let catFormatted = false; // category header has explicit height
...
for (let i = 3; i < data.length; i++) {
  ...
  // Subcategory: col B empty, ALL CAPS, and...
  //   - blank row above, OR
  //   - explicit row height (only in formatted categories)
  if (!c1 && isAllCaps && c2.length > 2 && (prevRowBlank || (catFormatted && hpt >= 17))) {
